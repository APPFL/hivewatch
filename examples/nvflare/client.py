...
def dataset_lock():
    ...
    with open(os.path.join(DATASET_PATH, ".cifar10.lock"), "w") as lock_file:
...
def main():
    ...
    while flare.is_running():
        ...
        print(f"site = {client_name}, current_round={current_round}")
        ...
        avg_train_loss = loss_total / max(loss_count, 1)
        accuracy = evaluate(model, test_loader, device)
        ...
        output_model = flare.FLModel(
            ...
            metrics={
                ...
                "train_time_sec": time.time() - train_started,
                **client_location,
            },
